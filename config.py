...
available_setting = {
    # openai api配置
    "open_ai_api_key": "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",  # openai api key
    ...
    "group_name_white_list": ["大冤种TIM"],  # 开启自动回复的群名称列表
    "group_name_keyword_white_list": [],  # 开启自动回复的群名称关键词列表
    "group_chat_in_one_session": ["大冤种TIM"],  # 支持会话上下文共享的群名称
